...
public class Get_Usernum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        task.execute( "http://ansimapk.dothome.co.kr/getjson.php", "");
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(Get_Usernum.this,
    ...
    private void showResult(){
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                String pass = item.getString(TAG_Pass);
